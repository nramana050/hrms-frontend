...
import PayslipGeneratorTable from "../PayslipGeneratorTable";
      ...
      <div className="dashboard-container">
        ...
        <div className="head-foot-part">
          <section>
            ...
            <PayslipGeneratorTable salary={salary} setRecDelete={setRecDelete} setFormVisible={setFormVisible} toggle={toggle} setToggle={setToggle}/>
          </section>
        </div>
      </div>
    </div>
