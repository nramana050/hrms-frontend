...
//           {Array.isArray(salary) && salary.length > 0 ? (
//             salary
...
//               ))
//           ) : (
//             renderSalaryData() // Render a message or UI when salary is empty
//           )}
        ...
        <div className=" table-ka-top-btns">
          ...
          <div className="search-print">
            ...
            <div className="d-flex mt-4 four-btn" style={{ gap: "10px" }}>
              ...
              {Array.isArray(salary) && salary.length > 0 && (
                <CSVLink
                  data={salary} // Ensuring salary is an array before passing it
                  filename="company.csv"
                  style={{ textDecoration: "none" }}
                >
                  <button
                  ...
                  .filter((elem) => {
                    if (search.length === 0) return elem;
                      ...
                      return (
                        ...
                        elem.ctc.toString().includes(search)
                      );
                  })
                  .map((salary, index) => (
                    <tr key={index}>
                      ...
                      <td className="mx-2">
                        <button
                          className="btn btn-danger"
                          onClick={() =>
                            handleDelete(salary.salaryTemplateId)
                          }
                        >
                          <FaTrashAlt />
                        </button>
          ...
          <tfoot>
            <tr>
              <CustomTablePagination
                ...
                rowsPerPageOptions={[5, 10, 25, { label: "All", value: -1 }]}
                colSpan={12}
                count={Array.isArray(salary) ? salary.length : 0} // Ensuring salary is an array before calculating its length
                rowsPerPage={rowsPerPage}
                page={page}
                slotProps={{
                  select: {
