        ...
        </Button>
        {
          <div className="search-print">
            ...
            <div className="d-flex mt-4 four-btn" style={{ gap: "10px" }} y>
              ...
              <CSVLink
                data={Object.values(company).map((item) => Object.values(item))}
            ...
            {company.length === 0
              ...
              : (rowsPerPage > 0
                  ...
                  .filter((elem) => {
                    ...
                    return (
                      elem.companyName.toLowerCase().includes(search.toLowerCase()) ||
                      elem.companyType.toLowerCase().includes(search.toLowerCase()) ||
                      elem.email.toLowerCase().includes(search.toLowerCase()) ||
                      elem.contactNumber.toString().includes(search) ||
                      elem.cin.toLowerCase().includes(search.toLowerCase()) ||
                      elem.gst.toLowerCase().includes(search.toLowerCase()) ||
                      elem.uan.toLowerCase().includes(search.toLowerCase()) ||
                  ...
                  .map((company, index) => (
                    <tr key={company.id}>
                      ...
                      <td className="mx-2">
                        <Link to={`/organisation/company-profile/${company.companyId}`}>
                          <FaEye className="action-eye" />
                        </Link>
                      </td>
                      <td className="mx-2">
                        <Link to={`/organisation/edit-company/${company.companyId}`}>
