...
export const saveCompany = async (formData) => {
  try {
    await axios.post("http://13.126.190.50:8081/company/create/company", formData, {
      headers: {
...
export const deleteCompany = async (id) => {
  try {
    console.log(id)
    await axios.delete(`http://13.126.190.50:8081/company/delete/${id}`);
  } catch (error) {
...
//             `http://13.126.190.50:8081/company/update/${id}`,formData,
//           );
...
//       `http://13.126.190.50:8081/company/update/${id}`,
//       formData
//     );
