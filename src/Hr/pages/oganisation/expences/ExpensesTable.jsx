...
const ExpensesTable = ({ expenses, setRecDelete, setFormVisible,
  setToggle,
  toggle, }) => {
      ...
      <tbody className="text-center">
        {expenses.length === 0 ? renderExpenseData() :(rowsPerPage > 0
            ...
            <tr key={expense.expenceId}>
              ...
              <td className="mx-2">
                <Link
                  to={`/organisation/edit-expences/${expense.expenceId}`}
                >
                  <FaEdit  className='action-edit'/>
                </Link>
              </td>
              <td className="mx-2">
                  <FaTrashAlt  className='action-delete' onClick={() => handleDelete(expense.expenceId)}
                  />
              </td>
            </tr>
          ))}
