...
import header from "../../../asset/images/Header.jpeg";
...
const ContraVoucherTable = ({ contraVoucher, setRecDelete,  setFormVisible,
  ...
  const emptyRows =
    page > 0 ? Math.max(0, (1 + page) * rowsPerPage - contraVoucher.length) : 0;
  ...
  const convertToExcel = () => {
    const ws = XLSX.utils.json_to_sheet(contraVoucher);
    ...
    XLSX.writeFile(wb, "contraVoucher.xlsx");
  };
            ...
            : (rowsPerPage > 0
                ...
                ?.filter((elem) => {
                  if (search.length === 0) return elem;
                    ...
                    return (
                      elem.contraVoucherListEntities?.accountName ||
                      ""
                        .toString()
                        .toLowerCase()
                  ...
                  <tr key={contraVoucher.contraVoucherId}>
                    ...
                    <td className="mx-2">
                      <button
                        ...
                        onClick={() =>
                          handleDelete(contraVoucher.contraVoucherId)
                        }
                      >
                        <FaTrashAlt />
                      </button>
