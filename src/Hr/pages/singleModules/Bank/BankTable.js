...
const BankTable = ({addbank,setRecDelete,  setFormVisible,
  setToggle,
  toggle,
}) => {
...
`;
  ...
  const emptyRows =
    page > 0 ? Math.max(0, (1 + page) * rowsPerPage - addbank.length) : 0;
  ...
  const convertToExcel = () => {
    const ws = XLSX.utils.json_to_sheet(addbank);
      ...
      <div className="table-start-container">
        ...
        <table id='table' className="table table-bordered table-hover shadow">
              ...
              <tbody className="text-center">
                {addbank.length === 0 ? renderBankData() : addbank && 
                 addbank.map((addbank, index) => (
                    <tr key={addbank.id}>
                      ...
                      <td className="mx-2">
                          ...
                          <FaTrashAlt  className='action-delete' onClick={() => deleteBank(addbank.addBankId)}
                          />
                      </td>
                    </tr>
                  ))}
