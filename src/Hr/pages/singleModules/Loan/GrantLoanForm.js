...
const GrantLoanForm = ({
  ...
  let buttonClick =
    ...
    formData.permittedBy.length > 0 &&
    formData.loanDetails.length > 0 &&
    formData.approveDate.length > 0 &&
    formData.repaymentForm.length > 0 &&
    formData.amount.length > 0 &&
    formData.interestPersentage.length > 0 &&
    formData.installmentPeriod.length > 0 &&
    formData.installmentCleared.length > 0;
