...
const ProjectTable = ({project,setRecDelete, setFormVisible,
  setToggle,
  toggle,}) => {
       ...
       <div className="table-start-container">
        <table id='table' className="table table-bordered table-hover shadow">
              ...
              <tbody className="text-center">
                { project.length === 0 ? renderProjectData() : (rowsPerPage > 0
          ...
          .filter((elem)=>{
            if(search.length===0)
              ...
              return (elem.projectTitle.toLowerCase().includes(search.toLocaleLowerCase()) ||
              elem.clientName.toLowerCase().includes(search.toLocaleLowerCase()) ||
              elem.companyName.toLowerCase().includes(search.toLocaleLowerCase()) ||
              elem.budget.toString().toLowerCase().includes(search.toLocaleLowerCase()) ||
              ...
              elem.endDate.toLowerCase().includes(search.toLocaleLowerCase()) 
                    ...
                    <tr key={project.projectsId}>
                      ...
                      <td className="mx-2">
                          ...
                          <FaTrashAlt className='action-delete' onClick={() => handleDelete(project.projectsId)}
                          />
                      </td>
                    </tr>
                  ))}
