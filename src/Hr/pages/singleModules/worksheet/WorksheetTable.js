...
const WorksheetTable = ({worksheet,setRecDelete,  setFormVisible,
  setToggle,
  toggle,
}) => {
...
const emptyRows =
page > 0 ? Math.max(0, (1 + page) * rowsPerPage - worksheet.length) : 0;
        ...
        <div className="table-start-container">
            <table id='table' className="table table-bordered table-hover shadow">
                  ...
                  <tbody className="text-center">
                    { worksheet.length === 0 ? renderWorksheetData() :(rowsPerPage > 0
            ? worksheet.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
            : worksheet
          )
          .filter((elem)=>{
            if(search.length===0)
              ...
              elem.project.toLowerCase().includes(search.toLocaleLowerCase()) ||
              elem.taskName.toLowerCase().includes(search.toLocaleLowerCase()) ||
              elem.workProgress.toString().toLowerCase().includes(search.toLocaleLowerCase()) ||
